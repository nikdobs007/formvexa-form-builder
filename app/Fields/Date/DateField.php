...
namespace formvexa\Fields\Date;
...
final class DateField extends BaseField
{
    ...
    {
        return __('Date', 'formvexa-form-builder');
    }
    ...
    public function defaults(): array
    {
        return [
            ...
            'label' => __('Date', 'formvexa-form-builder'),
    ...
    public function settings(): array
    {
        return [
            ...
            'General' => [
                ...
                Setting::date(
                    'default_value',
                    __('Default Date', 'formvexa-form-builder')
                ),
            ...
            'Validation' => [
                ...
                Setting::date(
                    'min',
                    __('Minimum Date', 'formvexa-form-builder')
                ),

                Setting::date(
                    'max',
                    __('Maximum Date', 'formvexa-form-builder')
                ),
            ],
        ];
    }
    ...
    public function validate($value = null): bool
    {
        ...
        if (
            ...
            return __('Date is required.', 'formvexa-form-builder');
        }
        ...
        if ($timestamp === false) {
            return __('Invalid date.', 'formvexa-form-builder');
        }
        ...
        if (
            ...
            return sprintf(
                ...
                __('Date must be after %s.', 'formvexa-form-builder'),
                $min
            );
        }
        ...
        if (
            ...
            return sprintf(
                /* translators: %s: Date in YYYY-MM-DD format. */
                __('Date must be before %s.', 'formvexa-form-builder'),
                $max
            );
        }
